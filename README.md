...
- Then run the project, the shortcut key is CTRL+F5.
- When directed to the website, it should warned you about it being unsafe so go to "advacned" then proceed to local host.
- And tada, it is basically like a baby project with extra steps.
